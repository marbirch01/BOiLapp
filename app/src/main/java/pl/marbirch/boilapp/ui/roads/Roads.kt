...
object Roads {
    ...
    //ZadWiel Open Task
    const val zadWielFirstStep = "zadWielFirstStep"
    const val zadWielSecondStep = "zadWielSecondStep"
    const val zadWielThirdStep = "zadWielThirdStep"
    const val zadWielFourthStep = "zadWielFourthStep"
    const val zadWielFifthStep = "zadWielFifthStep"
    const val zadWielSixthStep = "zadWielSixthStep"
}